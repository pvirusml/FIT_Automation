/*
* TC_1_55: Verify when the UE is on VoLTE enable WI-FI and perform VoLTE call
* -----------------------------------------------------
...
5. Ensure call is successful over VoLTE. End the Call.
*/
...
namespace FIT_Automation.Test_Cases
{
    public class TC_1_55
    {
        ...
        public TC_1_55(string dut1Id, string dut2Id, RichTextBox outputRTB, Button testButton)
        {
            _dut1Id = dut1Id;
            _dut2Id = dut2Id;
        ...
        public void RunTest()
        {
            ...
            lock (_lockObject)
            {
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 1.55: Verify when the UE is on VoLTE enable WI-FI and perform VoLTE call.");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                if (!gclass.PlaceCall(_dut1Id, dut2Number))
                    throw new Exception($"Failed to place VoLTE call from DUT 1 [{_dut1Id}] to DUT 2 [{_dut2Id}]");
                ...
                gclass.UpdateOutput($"TC 1.55: PASS [{_dut1Id}, {_dut2Id}]");
                _testButton.BackColor = System.Drawing.Color.Green;
                result = "PASS";
            }
            catch (Exception ex)
            {
                gclass.UpdateOutput($"TC 1.55: FAIL [{_dut1Id}, {_dut2Id}] - {ex.Message}");
            ...
            finally
            {
                ...
                gclass.LogTestResultToCSV("TC1.55", _dut1Id, result);
            }
        }
    }
}