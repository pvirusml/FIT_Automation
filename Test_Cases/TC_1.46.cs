/*
 * TC_1_46: Message Call rejection with Voicemail Notification: DUT1(VOLTE) to DUT2(VoWiFi)
 * -----------------------------------------------------
 * 
...
namespace FIT_Automation.Test_Cases
{
    public class TC_1_46
    {
        ...
        public TC_1_46(string dut1Id, string dut2Id, RichTextBox outputRTB, Button testButton)
        {
            _dut1Id = dut1Id;
            _dut2Id = dut2Id;
        ...
        public async Task RunTestAsync()
        {
            ...
            lock (_lockObject)
            {
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 1.46: Message Call rejection with Voicemail Notification: DUT1(VOLTE) to DUT2(VoWiFi)");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                else
                {
                    ...
                    gclass.UpdateOutput($"TC 1.46: PASS [{_dut1Id}, {_dut2Id}]");
            ...
            {
                gclass.UpdateOutput($"TC 1.46: FAIL [{_dut1Id}, {_dut2Id}] - {ex.Message}");
            ...
            gclass.LogTestResultToCSV("TC1.46", _dut1Id, result);
        }
    }
}
