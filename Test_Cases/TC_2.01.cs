/*
 * TC_2_01: MMS During VoWiFi Call to voWifi Test Case 
 * ------------------------------------------
 * Purpose:
...
namespace FIT_Automation.Test_Cases
{
    public class TC_2_01
    {
        ...
        public TC_2_01(string deviceId, RichTextBox outputRTB, Button testButton, string refDeviceId)
        {
            _deviceId = deviceId;
        ...
        public void RunTest()
        {
            ...
            lock (_lockObject)
            {
                ...
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 2.01: Verify MMS during VoWiFi call while calling VoWifi device...");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                if (!callActive)
                {
                    ...
                    gclass.UpdateOutput($"TC 2.01: FAIL [{_deviceId}, {_refDeviceId}] - Call was not established.", true);
                    _testButton.BackColor = System.Drawing.Color.Red;
                    gclass.LogTestResultToCSV("TC2.01", _deviceId, result);
                    return;
                }
                ...
                if (gclass.IsMMSSent)
                {
                    gclass.UpdateOutput($"TC 2.01: PASS [{_deviceId}, {_refDeviceId}]");
                    _testButton.BackColor = System.Drawing.Color.Green;
                    result = "PASS";
                }
                else
                {
                    gclass.UpdateOutput($"TC 2.01: FAIL [{_deviceId}, {_refDeviceId}]", true);
                    _testButton.BackColor = System.Drawing.Color.Red;
                    result = "FAIL";
                }
            }
            ...
            {
                gclass.UpdateOutput($"TC 2.01: FAIL [{_deviceId}, {_refDeviceId}] - {ex.Message}", true);
                _testButton.BackColor = System.Drawing.Color.Red;
                result = "FAIL";
            }
            finally
