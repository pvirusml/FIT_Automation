/*
* TC_1_78: Verify IMS registration by enabling "Wi-Fi Calling" switch with AP oN & SMS and Wi-Fi Calling Check
* -----------------------------------------------------
...
namespace FIT_Automation.Test_Cases
{
    public class TC_1_78
    {
        ...
        public TC_1_78(string dut1Id, RichTextBox outputRTB, Button testButton)
        {
            _dut1Id = dut1Id;
        ...
        public async Task RunTestAsync()
        {
            ...
            try
            {
                ...
                gclass.UpdateOutput($"TC 1.78: PASS [{_dut1Id}]");
                _testButton.BackColor = System.Drawing.Color.Green;
                result = "PASS";
            }
            catch (Exception ex)
            {
                gclass.UpdateOutput($"TC 1.78: FAIL [{_dut1Id}] - {ex.Message}");
            ...
            gclass.LogTestResultToCSV("TC1.78", _dut1Id, result);
        }
    }
}