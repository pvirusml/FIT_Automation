/*
 * TC_1_61: CFU with 3 VoWiFi Devices Test Case (Wi-Fi > Wi-Fi >> CS)
 * ------------------------------------------------
 * Purpose:
...
namespace FIT_Automation.Test_Cases
{
    public class TC_1_61
    {
        ...
        public TC_1_61(string dut1Id, string dut2Id, string moCallerId, RichTextBox outputRTB, Button testButton)
        {
            _dut1Id = dut1Id;
            _dut2Id = dut2Id;
        ...
        public void RunTest()
        {
            ...
            lock (_lockObject)
            {
                ...
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 1.61: Verify CFU with 3 VoWiFi devices: Wi-Fi > Wi-Fi >> CS");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                for (int i = 0; i < duration; i++)
                {
                    ...
                    if (!output.Contains("callstate=2"))
                    {
                        ...
                        gclass.UpdateOutput($"TC 1.61: FAIL [{_dut1Id}, {_dut2Id}, {_moCallerId}] - Call dropped early at {i} seconds.", true);
                ...
                if (callStillActive)
                {
                    ...
                    gclass.UpdateOutput($"TC 1.61: PASS [{_dut1Id}, {_dut2Id}, {_moCallerId}]");
                    _testButton.BackColor = System.Drawing.Color.Green;
                    result = "PASS";
                }
                else
                {
                    gclass.UpdateOutput($"TC 1.61: FAIL [{_dut1Id}, {_dut2Id}, {_moCallerId}]", true);
                    _testButton.BackColor = System.Drawing.Color.Red;
                    result = "FAIL";
                }
            ...
            {
                gclass.UpdateOutput($"TC 1.61: FAIL [{_dut1Id}, {_dut2Id}, {_moCallerId}] - {ex.Message}", true);
                _testButton.BackColor = System.Drawing.Color.Red;
                result = "FAIL";
            }
            finally
            ...
            gclass.LogTestResultToCSV("TC1.61", _dut1Id, result);
        }
    }
}
