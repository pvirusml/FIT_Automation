/*
 * TC_1_41: Video Call Forwarding Downgrade to Audio Test Case
 * -----------------------------------------------------------
 * Purpose:
...
namespace FIT_Automation.Test_Cases
{
    public class TC_1_41
    {
        ...
        public TC_1_41(string dut1Id, string dut2Id, RichTextBox outputRTB, Button testButton)
        {
            _dut1Id = dut1Id;
            _dut2Id = dut2Id;
        ...
        public void RunTest()
        {
            ...
            lock (_lockObject)
            {
                ...
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 1.41: Video Call Forwarding Downgrade to Audio to Upgrade back to video...");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                if (callStillActive)
                {
                    ...
                    gclass.UpdateOutput($"TC 1.41: PASS [{_dut1Id}, {_dut2Id}]");
                    _testButton.BackColor = System.Drawing.Color.Green;
                    result = "PASS";
                }
                else
                {
                    gclass.UpdateOutput($"TC 1.41: FAIL [{_dut1Id}, {_dut2Id}]", true);
                    _testButton.BackColor = System.Drawing.Color.Red;
                    result = "FAIL";
                }
            ...
            {
                gclass.UpdateOutput($"TC 1.41: FAIL [{_dut1Id}, {_dut2Id}] - {ex.Message}", true);
                _testButton.BackColor = System.Drawing.Color.Red;
                result = "FAIL";
            }
            finally
            ...
            gclass.LogTestResultToCSV("TC1.41", _dut1Id, result);
        }
    }
}