/*
 * TC_2_10: VoLTE CNIP (Calling Name Identity Presentation) Test Case
 * ------------------------------------------------------------------
 * Purpose:
...
namespace FIT_Automation.Test_Cases
{
    public class TC_2_10
    {
        ...
        public TC_2_10(string dut1Id, string dut2Id, string dut3Id, RichTextBox outputRTB, Button testButton)
        {
            _dut1Id = dut1Id;
            _dut2Id = dut2Id;
            _dut3Id = dut3Id;
        ...
        public void RunTest()
        {
            ...
            lock (_lockObject)
            {
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 2.10: VoLTE CNIP (Calling Name Identity Presentation) Test");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                for (int i = 0; i < 60; i++)
                {
                    ...
                    if (!callState.Contains("callstate=2"))
                    {
                        ...
                        gclass.UpdateOutput($"TC 2.10: FAIL [{_dut1Id}, {_dut2Id}, {_dut3Id}] - Call dropped early at {i} seconds.", true);
                ...
                if (callStillActive)
                {
                    gclass.UpdateOutput($"TC 2.10: PASS [{_dut1Id}, {_dut2Id}, {_dut3Id}]");
                    _testButton.BackColor = Color.Green;
                    result = "PASS";
                }
                else
                {
                    gclass.UpdateOutput($"TC 2.10: FAIL [{_dut1Id}, {_dut2Id}, {_dut3Id}]", true);
                    _testButton.BackColor = Color.Red;
                    result = "FAIL";
                }
            }
            ...
            {
                gclass.UpdateOutput($"TC 2.10: FAIL [{_dut1Id}, {_dut2Id}, {_dut3Id}] - {ex.Message}", true);
                _testButton.BackColor = Color.Red;
                result = "FAIL";
            }
            finally
            {
                ...
                gclass.LogTestResultToCSV("TC2.10", _dut1Id, result);
            }
        }
    }
}
