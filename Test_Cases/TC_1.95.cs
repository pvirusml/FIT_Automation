/*
 * TC_1_95: VoWiFi MMS to VoWiFi(On AP mode) Device Test Case
 * -----------------------------------------------
 * Purpose:
...
namespace FIT_Automation.Test_Cases
{
    public class TC_1_95
    {
        ...
        public TC_1_95(string deviceId, RichTextBox outputRTB, Button testButton, string refDeviceId)
        {
            _deviceId = deviceId;
        ...
        public void RunTest()
        {
            ...
            lock (_lockObject)
            {
                ...
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 1.95: Verify MMS from VoWiFi device camping on cellular is sent to VoWiFi device On AP Mode...");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                if (!dutRegistered)
                {
                    ...
                    gclass.UpdateOutput($"TC 1.95: FAIL [{_deviceId}, {_refDeviceId}]", true);
                    gclass.LogTestResultToCSV("TC1.95", _deviceId, result);
                    return;
                }
                */
                ...
                if (gclass.IsMMSSent)
                {
                    gclass.UpdateOutput($"TC 1.95: PASS [{_deviceId}, {_refDeviceId}]");
            ...
            {
                gclass.UpdateOutput($"TC 1.95: FAIL [{_deviceId}, {_refDeviceId}] - {ex.Message}", true);
                _testButton.BackColor = System.Drawing.Color.Red;
                result = "FAIL";
            }
            finally
