/*
* TC_1_58: MT VoWiFi calls during Data/Messaging
* -----------------------------------------------------
...
namespace FIT_Automation.Test_Cases
{
    public class TC_1_58
    {
        ...
        public TC_1_58(string dut1Id, string dut2Id, RichTextBox outputRTB, Button testButton)
        {
            _dut1Id = dut1Id;
            _dut2Id = dut2Id;
        ...
        public void RunTest()
        {
            ...
            lock (_lockObject)
            {
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 1.58: MT VoWiFi calls during Data/Messaging");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                if (!gclass.PlaceCall(_dut2Id, dut1Number))
                    throw new Exception($"Failed to place VoWiFi call from DUT 2 [{_dut2Id}] to DUT 1 [{_dut1Id}]");
                ...
                gclass.SendSMS(_dut2Id, dut1Number, "Test SMS");
                Thread.Sleep(5000);
                ...
                gclass.SendMMS(_dut2Id, dut1Number, "Test MMS");
                ...
                gclass.UpdateOutput($"TC 1.58: PASS [{_dut1Id}, {_dut2Id}]");
                _testButton.BackColor = System.Drawing.Color.Green;
                result = "PASS";
            }
            catch (Exception ex)
            {
                gclass.UpdateOutput($"TC 1.58: FAIL [{_dut1Id}, {_dut2Id}] - {ex.Message}");
            ...
            finally
            {
                ...
                gclass.LogTestResultToCSV("TC1.58", _dut1Id, result);
            }
        }
    }
}