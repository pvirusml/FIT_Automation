/*
 * TC_1_96: VoWiFi MMS to VoWiFi Device Test Case
 * -----------------------------------------------
 * Purpose:
...
namespace FIT_Automation.Test_Cases
{
    public class TC_1_96
    {
        ...
        public TC_1_96(string deviceId, RichTextBox outputRTB, Button testButton, string refDeviceId)
        {
            _deviceId = deviceId;
        ...
        public void RunTest()
        {
            ...
            lock (_lockObject)
            {
                ...
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 1.96: Verify MMS from VoWiFi device camping on cellular is sent to VoWiFi device...");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                if (!dutRegistered)
                {
                    ...
                    gclass.UpdateOutput($"TC 1.96: FAIL [{_deviceId}, {_refDeviceId}]", true);
                    gclass.LogTestResultToCSV("TC1.96", _deviceId, result);
                    return;
                }
                */
                ...
                if (gclass.IsMMSSent)
                {
                    gclass.UpdateOutput($"TC 1.96: PASS [{_deviceId}, {_refDeviceId}]");
            ...
            {
                gclass.UpdateOutput($"TC 1.96: FAIL [{_deviceId}, {_refDeviceId}] - {ex.Message}", true);
                _testButton.BackColor = System.Drawing.Color.Red;
                result = "FAIL";
            }
            finally
