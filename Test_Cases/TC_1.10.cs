        ...
        public void RunTest()
        {
            ...
            try
            {
                ...
                if (!gclass.WaitForLTEAndVoLTERegistration(_deviceId) || !gclass.WaitForLTEAndVoLTERegistration(_refDeviceId))
                {
                    ...
                    gclass.UpdateOutput($"TC 1.10: FAIL [{_deviceId}, {_refDeviceId}]", true);
                ...
                if (gclass.IsSMSSent)
                {
                    gclass.UpdateOutput($"TC 1.10: PASS [{_deviceId}, {_refDeviceId}]");
            ...
            {
                gclass.UpdateOutput($"TC 1.10: FAIL [{_deviceId}, {_refDeviceId}] - {ex.Message}", true);
                _testButton.BackColor = System.Drawing.Color.Red;
                result = "FAIL";
            }
