/*
* TC_1_73: Verify by default the WiFi preferred policy is used  by the device
* -----------------------------------------------------
1. Verify by default the WiFi preferred policy is used  by the device
*/
...
namespace FIT_Automation.Test_Cases
{
    public class TC_1_73
    {
        ...
        public TC_1_73(string dut1Id, RichTextBox outputRTB, Button testButton)
        {
            _dut1Id = dut1Id;
        ...
        public async Task RunTestAsync()
        {
            ...
            lock (_lockObject)
            {
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 1.73: Verify by default the WiFi preferred policy is used  by the device");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                gclass.UpdateOutput($"TC 1.73: PASS [{_dut1Id}]");
                _testButton.BackColor = System.Drawing.Color.Green;
                result = "PASS";
            }
            catch (Exception ex)
            {
                gclass.UpdateOutput($"TC 1.73: FAIL [{_dut1Id}] - {ex.Message}");
            ...
            gclass.LogTestResultToCSV("TC1.73", _dut1Id, result);
        }
    }
}