/*
 * TC_2_04: SMS from VoLTE to VoWifi Device Test Case
 * -----------------------------------------------
 * Purpose:
...
namespace FIT_Automation.Test_Cases
{
    public class TC_2_04
    {
        ...
        public TC_2_04(string deviceId, RichTextBox outputRTB, Button testButton, string refDeviceId)
        {
            _deviceId = deviceId;
        ...
        public void RunTest()
        {
            ...
            lock (_lockObject)
            {
                ...
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 2.04: Verify SMS from SMS from VoLTE to VoWifi device");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                if (!dutRegistered)
                {
                    ...
                    gclass.UpdateOutput($"TC 2.04: FAIL [{_deviceId}, {_refDeviceId}]", true);
                    gclass.LogTestResultToCSV("TC2.04", _deviceId, result);
                    return;
                }
                ...
                if (gclass.IsSMSSent)
                {
                    gclass.UpdateOutput($"TC 2.04: PASS [{_deviceId}, {_refDeviceId}]");
            ...
            {
                gclass.UpdateOutput($"TC 2.04: FAIL [{_deviceId}, {_refDeviceId}] - {ex.Message}", true);
                _testButton.BackColor = System.Drawing.Color.Red;
                result = "FAIL";
            }
            finally
