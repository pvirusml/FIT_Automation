/*
 * TC_1_60: VoWiFi > CS + VoWiFi Call merge between 3 devices
...
namespace FIT_Automation.Test_Cases
{
    public class TC_1_60
    {
        ...
        public TC_1_60(string dut1Id, string dut2Id, string dut3Id, RichTextBox outputRTB, Button testButton)
        {
            _dut1Id = dut1Id;
            _dut2Id = dut2Id;
            _dut3Id = dut3Id;
        ...
        public void RunTest()
        {
            ...
            lock (_lockObject)
            {
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 1.60:  VoWiFi > CS + VoWiFi Call merge between 3 devices");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                gclass.UpdateOutput($"TC 1.60: PASS [{_dut1Id}, {_dut2Id}, {_dut3Id}]");
                _testButton.BackColor = System.Drawing.Color.Green;
                result = "PASS";
            }
            catch (Exception ex)
            {
                gclass.UpdateOutput($"TC 1.60: FAIL [{_dut1Id}, {_dut2Id}, {_dut3Id}] - {ex.Message}");
            ...
            finally
            {
                ...
                gclass.LogTestResultToCSV("TC1.60", _dut1Id, result);
            }
        }
    }
}