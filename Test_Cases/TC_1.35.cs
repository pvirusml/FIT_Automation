/*
 * TC_1_35: Voicemail Notification and Callback Test Case
 * -----------------------------------------------------
 * Purpose:
...
namespace FIT_Automation.Test_Cases
{
    public class TC_1_35
    {
        ...
        public TC_1_35(string dut1Id, string dut2Id, RichTextBox outputRTB, Button testButton)
        {
            _dut1Id = dut1Id;
            _dut2Id = dut2Id;
        ...
        public async Task RunTestAsync()
        {
            ...
            lock (_lockObject)
            {
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 1.35: VoWiFi DUTs on hold");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                await Task.Delay(3000); // Wait for the notification shade to open
                    ...
                    gclass.UpdateOutput($"TC 1.35: PASS [{_dut1Id}, {_dut2Id}]");
            ...
            {
                gclass.UpdateOutput($"TC 1.35: FAIL [{_dut1Id}, {_dut2Id}] - {ex.Message}");
