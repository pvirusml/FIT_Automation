/*
 * TC_2_05: SMS During VoWiFi Call to voWifi on AP Mode Test Case 
 * ------------------------------------------
 * Purpose:
 *   Verify that an SMS can be sent during a VoWiFi call and is received by the reference device.
 * 
 * Steps:
...
namespace FIT_Automation.Test_Cases
{
    public class TC_2_05
    {
        ...
        public TC_2_05(string deviceId, RichTextBox outputRTB, Button testButton, string refDeviceId)
        {
            _deviceId = deviceId;
        ...
        public void RunTest()
        {
            ...
            lock (_lockObject)
            {
                ...
                if (!headerLogged)
                {
                    gclass.UpdateOutput("\n");
                    gclass.UpdateOutput("==================================================");
                    gclass.UpdateOutput("Starting TC 2.05: Verify SMS during VoWiFi call while calling VoWifi device on AP mode...");
                    gclass.UpdateOutput("==================================================\n");
                    headerLogged = true;
                }
            }
            ...
            try
            {
                ...
                if (!callActive)
                {
                    ...
                    gclass.UpdateOutput($"TC 2.05: FAIL [{_deviceId}, {_refDeviceId}] - Call was not established.", true);
                    _testButton.BackColor = System.Drawing.Color.Red;
                    gclass.LogTestResultToCSV("TC2.05", _deviceId, result);
                    return;
                }
                ...
                if (gclass.IsSMSSent)
                {
                    gclass.UpdateOutput($"TC 2.05: PASS [{_deviceId}, {_refDeviceId}]");
                    _testButton.BackColor = System.Drawing.Color.Green;
                    result = "PASS";
                }
                else
                {
                    gclass.UpdateOutput($"TC 2.05: FAIL [{_deviceId}, {_refDeviceId}]", true);
                    _testButton.BackColor = System.Drawing.Color.Red;
                    result = "FAIL";
                }
            }
            ...
            {
                gclass.UpdateOutput($"TC 2.05: FAIL [{_deviceId}, {_refDeviceId}] - {ex.Message}", true);
                _testButton.BackColor = System.Drawing.Color.Red;
                result = "FAIL";
            }
            finally
